"""squad_studio_20723 URL Configuration
...
admin.site.site_header = "Squad Studio"
admin.site.site_title = "Squad Studio Admin Portal"
admin.site.index_title = "Squad Studio Admin"

# swagger
api_info = openapi.Info(
    title="Squad Studio API",
    default_version="v1",
    description="API documentation for Squad Studio App",
)
